...
export const pilatesPrices = [
  { name: "Mat Pilates", duration: "50 min", price: "160 Kč", desc: "Dynamické, intenzivnější tempo." },
  {
    name: "Slow & Gentle Pilates",
    duration: "50 min",
    price: "160 Kč",
    desc: "Pomalejší tempo pro začátečníky.",
  },
  {
    name: "Morning Pilates Flow",
    duration: "50 min",
    price: "160 Kč",
    desc: "Plynulé ranní nastartování dne.",
  },
