  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-linen">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 bg-leaves bg-no-repeat bg-left-bottom bg-[length:260px_auto] lg:bg-[length:560px_auto] opacity-40 mix-blend-multiply"
        />
